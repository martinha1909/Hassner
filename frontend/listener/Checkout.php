...
<div style="padding-top:50px;" class="row">
  <div class="col-75">
    <div class="container">
      <form action="../../backendend/shared/CardVerificationBackend.php" method="post">
      
        <div class="row">
          <div class="col-50">
            <h3>Billing Address</h3>
            <h5 class="text-right"><a href="../../backendend/shared/UseSavedPaymentInfoBackend.php" onclick='window.location.reload();' class="btn btn-primary py-2">Use saved payment info</a></h5>
