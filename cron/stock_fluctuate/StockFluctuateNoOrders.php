<?php
    ...
    */
    ...
    include HX_INCLUDE_DIR."/backend/shared/include/TimeUtil.php";
    ...
    $close_start_time = date('Y-m-d 00:00:00');
    $close_end_time = date('Y-m-d 08:00:00');
    if(isInRange($current_date, $close_start_time, $close_end_time))
    {
        echo "Not in fluctuate window, skipping...";
    }
    else
    {
