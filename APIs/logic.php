<?php
        ...
        function updateAskedPrice($conn, $user_username, $artist_username, $quantity, $asked_price, $new_pps, $date_bought)
        {
            ...
            $sql = "UPDATE user_artist_sell_share SET date_bought = '$date_bought' WHERE WHERE user_username = '$user_username' AND artist_username = '$artist_username' AND selling_price = '$quantity'";
            $conn->query($sql);
        ...
        function updateExistedSellingShare($conn, $user_username, $artist_username, $quantity, $asked_price, $current_time)
        {
            ...
            $sql = "UPDATE user_artist_sell_share SET date_bought = '$current_time' WHERE user_username = '$user_username' AND artist_username = '$artist_username'";
            $conn->query($sql);
        }

        function postAskedPrice($conn, $user_username, $artist_username, $quantity, $asked_price, $new_pps, $date_bought)
        {
            $sql = "INSERT INTO user_artist_sell_share (user_username, artist_username, selling_price, no_of_share, date_bought)
                    VALUES(?, ?, ?, ?, ?)";
            $stmt = $conn->prepare($sql);
            $stmt->bind_param('ssdis', $user_username, $artist_username, $asked_price, $quantity, $date_bought);
            $stmt->execute();
