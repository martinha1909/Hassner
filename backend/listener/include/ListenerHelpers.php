<?php
    ...
    */
    function fetchInvestedArtistCampaigns($user_username)
    {
        ...
        while($row = $res->fetch_assoc()) 
        {
            ...
            $total_shares_bought = calculateTotalNumberOfSharesBought($user_username, $campaign_info['artist_username']);
    ...
    */
    ...
    function topsAndFlops($all_artists)
    {
        ...
        echo '
            <b class="h3-blue">Tops And Flops</b><a data-toggle="tooltip" title="The best and worst performing ethos of the day." class="tooltip-pointer"> ⓘ</a>
    ...
    function followedArtist($user_username)
    {
        ...
        echo '
            <b class="h3-blue">Followed</b><a data-toggle="tooltip" title="List of artists you are following." class="tooltip-pointer"> ⓘ</a>  
            <form action="../../backend/artist/ArtistShareInfoBackend.php" method="post">
        ';
    ...
    function apex($all_artists)
    {
        ...
        echo '
            <b class="h3-blue">Apex</b><a data-toggle="tooltip" title="Artists with the highest market cap on the platform." class="tooltip-pointer"> ⓘ</a>
            <form action="../../backend/artist/ArtistShareInfoBackend.php" method="post">
        ';
    ...
    function localArtist()
    {
        ...
        echo '
            <b class="h3-blue ">Local artist</b><a data-toggle="tooltip" title="Nearby artists (not available during testing phase)." class="tooltip-pointer"> ⓘ</a>
        ';
    }
?>